...
<span id="Booking"></span>
    ...
    <div class="col-md-10 left align-center" style="margin: 0 auto; margin-top: 20px; background-color: #fff; padding: 20px; border-radius: 10px;">
        <div class="left_container">
            ...
            <h1 class="text-primary prevent-select" style="margin-top: 10px;">Meriton Suites Sussex Street, Chandigarh</h1>
            <p>Located i Chandigarh CBD and surrounded by some o Chandigarh's most popular tourist attractions and iconic landmarks, Meriton Suites Sussex Street Chandigarh <br>provides 5-star luxury accommodation. The property boasts a range of facilities including a 24-hour fitness centre, indoor heated pool, hot tub and <br>sauna, free WiFi and a 24-hour reception. Barangaroo, SEALIF Chandigarh Aquarium and Cockle Bay Wharf are just a short walk away.
<br>
The spacious suites offered at Meriton Suites Sussex Street Chandigarh are fitted with a gourmet kitchen or kitchenette with a Nespresso coffee machine, designerbr
 bathrooms, a dining area and a living area with a flat-screen TV with cable channels to relax after a busy day. Some suites feature sea views.
<br>
There is a range of entertainment, cafe, bar and dining options offered nearby Meriton Suites Sussex Street Chandigarh and at Darling Harbour, just a 5-minute walk from
<br> the property. You can also enjoy wandering around beautiful Hyde Park, a 10-minute walk away or take advantage of the many shopping malls located nearby including <br> the QVB which is a 5-minute walk from the property. Car parking entry is located in Druitt Place, via a car lift access.
</p>
...
if(isset($_POST['submit_comp'])){
  ...
  $complaint_from = "Meriton Suites Sussex Street, Chandigarh";
