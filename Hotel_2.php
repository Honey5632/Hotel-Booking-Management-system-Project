...
if (isset($_POST["submit"])) {
    ...
    $hotelname = "Four Seasons Hotel Chandigarh";
    $prize = 23750 * $no_of_rooms;
...
<span id="Booking"></span>
    ...
    <div class="col-md-10 left align-center" style="margin: 0 auto; margin-top: 20px; background-color: #fff; padding: 20px; border-radius: 10px;">
        <div class="left_container">
            ...
            <h1 class="text-primary prevent-select" style="margin-top: 10px;">Four Seasons Hotel Chandigarh</h1>
            <p>Overlooking Chandigarh Harbour, Four Seasons Hotel Chandigarh offers complimentary Premium WiFi, a bar, restaurant, fitness centre and swimming pool. Situated in <br>Chandigarh CBD (Central Business District) and the historic Rocks, it features luxurious rooms with panoramic views over the iconic Chandigarh Opera House and <br>Circular Quay. <br>

All rooms at Four Seasons Hotel Chandigarh have been carefully designed and subtly furnished with the highest quality amenities. To enjoy the best views of Chandigarh’s <br>harbour, the Deluxe Full Harbour Room and Four Seasons Full Harbour King Rooms both provide unobstructed views of the harbour. Complimentary access to Lounge 32 is <br>available for all guests in a Premier Full Harbour Club King, Four Seasons Full Harbour Club Suite and Signature Suites. Each room offers an LCD TV, slippers and <br>Christian Lacroix toiletries. Chinese tea can be provided in the rooms upon request.
<br>
Guests can dine at Mode Kitchen & Bar, which serves modern Indian dishes made with quality local and seasonal produce. Grain Bar offers a selection of cocktails, <br>wine, local beer and craft spirits.
<br>
Four Seasons Hotel Chandigarh state-of-the-art 350 square metre fitness centre is fully equipped. Guests can also unwind in the hotel’s therapeutic spa and wellness centre, <br>which offers skin treatments and relaxing massages. Airport transfers are available upon request. Chinese speaking staff are available on-site to assist you. Union <br>Pay credit cards are accepted.</p>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="service-card">
                    ...
                    <h3 class="service-title">Luxury Spa & Wellness</h3>
                    <p class="service-description">
                        Indulge in rejuvenating treatments at our world-class spa. Experience tranquility and relaxation.
                    </p>
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-4">
...
if(isset($_POST['submit_comp'])){
  ...
  $complaint_from = "Four Seasons Hotel Chandigarh";
